...
// --- Icons ---
import { AlignCenterIcon } from "@/app/(admin)/_components/text-editor/tiptap-icons/align-center-icon"
import { AlignJustifyIcon } from "@/app/(admin)/_components/text-editor/tiptap-icons/align-justify-icon"
import { AlignLeftIcon } from "@/app/(admin)/_components/text-editor/tiptap-icons/align-left-icon"
import { AlignRightIcon } from "@/app/(admin)/_components/text-editor/tiptap-icons/align-right-icon"
