...
// --- Icons ---
import { HeadingOneIcon } from "@/app/(admin)/_components/text-editor/tiptap-icons/heading-one-icon"
import { HeadingTwoIcon } from "@/app/(admin)/_components/text-editor/tiptap-icons/heading-two-icon"
import { HeadingThreeIcon } from "@/app/(admin)/_components/text-editor/tiptap-icons/heading-three-icon"
import { HeadingFourIcon } from "@/app/(admin)/_components/text-editor/tiptap-icons/heading-four-icon"
import { HeadingFiveIcon } from "@/app/(admin)/_components/text-editor/tiptap-icons/heading-five-icon"
import { HeadingSixIcon } from "@/app/(admin)/_components/text-editor/tiptap-icons/heading-six-icon"
