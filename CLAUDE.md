...
1. Build the landing page
    ...
    3. Create Topics Covered Section with this elements
        1. Headline
        2. Create cards for the following topics (Vocabulary, Grammar, Reading, Writing).Each card should include an icon representation (use Lucide library already installed), short description (1-2 sentences)
